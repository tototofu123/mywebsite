...
Relationship-oriented communicator with proven experience securing corporate sponsorships, presenting to government bodies, and managing a 200+ member community. Technically literate — able to understand and credibly pitch complex technology products.
...
**Sport Climbing Society Webpage** | Figma · GitHub
- Directed full UI/UX overhaul; improved site architecture for member discovery and registration conversion
- Maintained Git version control for iterative updates and collaborative codebase

**International Student Support Agent** | Dify · RAG
- Defined requirements across student users and institutional stakeholders; shipped with privacy compliance

**All-in-One Combat Bot — Team Lead** | Arduino · BLE
- Led 4-person cross-functional team; managed timeline and delivered 1st-place result among 20+ teams
